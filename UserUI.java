 ...
 * @author Samantha
 */
public class UserUI extends javax.swing.JFrame implements ActionListener, CommonData {
   //attribute has user
   String username;
   ...
   public void actionPerformed(ActionEvent ae) {
      if( ae.getActionCommand().equals("Generate Data")){
         ...
         //create Intermediary
         Intermediary newData = new Intermediary( username, major, minor, QUICKEST );
